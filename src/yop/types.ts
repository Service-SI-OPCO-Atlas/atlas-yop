...
export type Constructor<Type> =
    Type extends unknown ? abstract new (...args: any) => NonNullable<Type> :
...
export type ArrayElementType<ArrayType> = ArrayType extends Array<infer ElementType> ? ElementType : unknown
